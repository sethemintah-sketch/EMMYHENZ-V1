...
# Clone repository
git clone https://github.com/emmyhenz/EMMYHENZ-V1
cd emmyhenz-v1
...
module.exports = {
    ...
    phoneNumber: "" // Don't Add If You Are Using Panel To Deploy
};
```
...
For premium features and 24/7 uptime, deploy on a VPS or hosting panel:

**📚 Detailed Tutorial:** [Panel Deployment Guide](https://t.me/cyber_xph/189)
...
- Users are responsible for complying with WhatsApp Terms of Service
...
- **WhatsApp Web.js** - Core WhatsApp API
- **Baileys** - WhatsApp connection library
